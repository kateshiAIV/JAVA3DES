...
class DES {
    public static byte[] TDESencrypt(byte[] buffer, SecretKey myDesKey1, SecretKey myDesKey2, SecretKey myDesKey3, Cipher myCipher,IvParameterSpec ivSpec)
...
//            byte[] myTransformedBytes = buffer;  // Operate on the incoming buffer
        ...
        public static byte[] TDESdecrypt(byte[] buffer, SecretKey myDesKey1, SecretKey myDesKey2, SecretKey myDesKey3, Cipher myCipher,IvParameterSpec ivSpec)
                throws IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidKeySpecException, NoSuchPaddingException,
                IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException {
